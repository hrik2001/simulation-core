...
This code is based on the logging module from curvesim (https://github.com/curveresearch/curvesim),
which is released under the MIT License (https://opensource.org/licenses/MIT).

The original curvesim code can be found at: https://github.com/curveresearch/curvesim/blob/main/curvesim/logging.py
"""
...
DEFAULT_LEVEL = "info"
USE_LOG_FILE = os.getenv("USE_LOG_FILE", False)
# --------------------------------------------------- #
