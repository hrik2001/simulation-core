...
from .models import Borrow, AuctionStarted, AuctionFinished, Repay, MetricSnapshot, SimSnapshot, OracleSnapshot, AccountAssets
from .types import arcadia__Borrow, arcadia__AuctionStarted, arcadia__AuctionFinished, arcadia__Repay, arcadia__MetricSnapshot, arcadia__SimSnapshot, arcadia__OracleSnapshot, arcadia__AccountAssets
...
class Query(ObjectType):
    ...
    all_account_assets = graphene.List(arcadia__AccountAssets, account=String(), limit=Int(), sort_by=String())
