...
minimal_abi = [
    ...
    },
    {
        ...
        "outputs": [{"name": "collateralValue", "type": "uint256"}],
        "payable": False,
        "stateMutability": "view",
        "type": "function",
    },
    ...
    {
        "constant": True,
        "inputs": [{"name": "numeraire_", "type": "address"}],
        "name": "getAccountValue",
        "outputs": [{"name": "accountValue", "type": "uint256"}],
        "payable": False,
        "stateMutability": "view",
        "type": "function",
    },
...
lending_pool_abi = [
    {
        ...
        "outputs": [{"name": "openPosition", "type": "uint256"}],
        "payable": False,
        "stateMutability": "view",
        "type": "function",
    },
    ...
    },
    {
        "inputs": [],
        "name": "totalLiquidity",
        "outputs": [{"internalType": "uint256", "name": "totalLiquidity_", "type": "uint256"}],
        "stateMutability": "view",
        "type": "function",
    },
]
...
def get_web3(chain_name):
    return Web3(Web3.HTTPProvider(Chain.objects.get(chain_name__iexact=chain_name).rpc))
...
def get_oracle_information(oracle_count: int):
    ...
    for i in range(oracle_count):
        ...
        if oracle_address:
            ...
            oracle_dict = {"oracleId": i, "oracleAddress": oracle_address, "oracleDesc": oracle_description}
...
def get_risk_factors(
    web3, creditor, asset_addresses, asset_ids, contract_address="0xd0690557600eb8Be8391D1d97346e2aab5300d5f"
):
    ...
    collateral_factors, liquidation_factors = contract.functions.getRiskFactors(
        Web3.to_checksum_address(creditor), [Web3.to_checksum_address(addr) for addr in asset_addresses], asset_ids
    ).call()
