...
def get_drawdowns(request):
    ...
    drawdown_df = pd.concat([pd.read_csv(btc_path), pd.read_csv(eth_path)], ignore_index=True)
    ...
    drawdown_df["duration"] = drawdown_df["drawdown_end"] - drawdown_df["drawdown_start"]
