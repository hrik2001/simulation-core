...
OPTIMISM_DTO = chainDTO(network="Optimism", network_id=10)

ARIBTRUM_DTO = chainDTO(network="Arbitrum", network_id=42161)

ETHEREUM_DTO = chainDTO(network="Ethereum", network_id=1)
